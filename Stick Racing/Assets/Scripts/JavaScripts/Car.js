private var accelerationTimer : float;
...
public var IR_Script : InputBehaviour;
private var GMM_Script : GameModeManager;
...
function Start()
{	
	IR_Script = GameObject.Find("Main Camera").GetComponent(InputBehaviour);
